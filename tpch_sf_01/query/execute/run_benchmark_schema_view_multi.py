...
# Schema-driven multi-view templates contain only combinations whose component
# templates all come from schema_driven.
TEMPLATES_DIR = Path(__file__).resolve().parents[1] / "templates_multiple" / "schema_driven"
RESULTS_DIR = Path(__file__).resolve().parents[1] / "results_multi_view" / "schema_driven"
