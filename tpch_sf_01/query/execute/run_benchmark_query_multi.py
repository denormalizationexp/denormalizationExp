...
# Query-driven multi templates use the superset: query-specific combinations
# plus copied schema-driven combinations.
TEMPLATES_DIR = Path(__file__).resolve().parents[1] / "templates_multiple" / "query_driven"
RESULTS_DIR = Path(__file__).resolve().parents[1] / "results_multiple" / "query_driven"
...
def warmup(cur, name: str, query: str, warmup_runs: int = 0) -> None:
